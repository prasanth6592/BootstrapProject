...
.controller('todo', function($scope,$http, $uibModal,$log,addTodo,Gettodo,Getroles,postFactory,updateFactory,modalService,modalMessageService) {
   $scope.selectRow = 0;
...
.controller('ModalInstanceCtrl', function($scope,$log, $uibModalInstance,Getroles,addTodo,ind, items,addto,postFactory,updateFactory,modalService,modalMessageService){
  $scope.items = items;
...
//  console.log(items)
  $scope.close = function(){
    ...
    //get roles list here using resource service
   var entries = Getroles.getroles().query()
                  .$promise.then(
                    function(response){
